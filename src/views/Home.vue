        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La Unidad 2 profundiza en las didácticas específicas, enfocándose en su aplicación, según disciplinas, niveles educativos, tipos de instituciones y características de los estudiantes. Se diferencian de la didáctica general por su adaptabilidad contextual y metodológica. Esta Unidad analiza criterios como la contextualización disciplinar, la flexibilidad metodológica y la evaluación pertinente. También considera la diversidad, inclusión y equidad en el aula, promoviendo estrategias ajustadas a cada realidad educativa. El objetivo es formar docentes capaces de diseñar prácticas pedagógicas significativas, transformadoras y adaptadas a las necesidades actuales de la enseñanza.
